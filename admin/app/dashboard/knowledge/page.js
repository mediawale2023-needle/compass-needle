...
import ParliamentSyncPage from '@/app/dashboard/parliament-sync/page';
                                    ...
                                    <tr key={row.tenant_id}>
                                        ...
                                        <td>
                                            <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                                                ...
                                                <Link className="btn-secondary" style={{ padding: '5px 10px', fontSize: '0.72rem', textDecoration: 'none' }} href={`/dashboard/profiles?tenant_id=${row.tenant_id}`}>
                                                    MP Profile
                                                </Link>
                                            </div>
                                        </td>
        ...
        <div style={{ display: 'grid', gap: 18 }}>
            <div className="glass-panel" style={{ padding: 14 }}>
                ...
                <div style={{ marginTop: 10, color: '#6b7f76', fontSize: '0.75rem' }}>
                    ...
                    {' '}and{' '}
                    <Link href="/dashboard/parliament-sync" style={{ color: '#006a4d', fontWeight: 700 }}>Parliament Sync</Link>.
                </div>
            </div>
