        ...
        <>
            ...
            >
                ...
                <div className={cn("flex items-center gap-3 px-4 h-16 border-b border-border", collapsed && "md:justify-center md:px-2")}>
                    <div className="h-10 w-10 rounded-xl flex items-center justify-center shrink-0 shadow-sm bg-primary">
                ...
                <div className={cn("px-4 py-3 border-b border-border", collapsed && "md:px-2 md:py-3")}>
                    <div className={cn("flex items-center gap-3", collapsed && "md:justify-center")}>
                        <div className="h-9 w-9 rounded-full flex items-center justify-center text-sm font-semibold shrink-0 bg-secondary text-secondary-foreground">
                        ...
                        <div className={cn("flex-1 min-w-0", collapsed && "md:hidden")}>
                            ...
                            <p className="text-xs text-muted-foreground truncate">
                                {user?.constituency || 'Your Constituency'}
                            </p>
                        </div>
                    </div>
                </div>
